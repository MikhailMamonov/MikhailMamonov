...
Проектирую и разрабатываю отказоустойчивые системы и высоконагруженные интеграционные решения на стеке .NET. Специализируюсь на создании чистого, поддерживаемого и высокопроизводительного кода.
