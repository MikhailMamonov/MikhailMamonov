...
Проектирую и разрабатываю отказоустойчивые системы и высоконагруженные интеграционные решения на стеке .NET. Специализируюсь на создании чистого и поддерживаемого кода.
